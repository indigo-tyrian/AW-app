  ...
  return (
    <>
      ...
      <div className={`${contentStyle} ${containerStyle}`}>
        ...
        <ImgWindow title1='Sandy Beach' totalNumber={110} imgSource='/images/livingThings/habitats/sandyBeach.jpg' link="/livingThings/habitats/sandyBeach" />
        <ImgWindow title1='Deep Sea' totalNumber={110} imgSource='/images/livingThings/habitats/deepSea.jpg' link="/livingThings/habitats/deepSea" />
        ...
        <ImgWindow title1='Rocky Shore' totalNumber={110} imgSource='/images/livingThings/habitats/rockyShore.jpg' link="/livingThings/habitats/rockyShore" />
        ...
        <ImgWindow title1='Tropical Rain Forest' totalNumber={110} imgSource='/images/livingThings/habitats/tropicalRainForest.jpg' link="/livingThings/habitats/tropicalRainForest" />
      </div>
    </>
  )
}
