  ...
  return (
    <>
      ...
      <div className={`${contentStyle} ${containerStyle}`}>
        ...
        <ImgWindow title1='Japanese Style' totalNumber={110} imgSource='/images/arts/paintingStyles/japanese_painting-Prune_sur_paravent_par_Kanō_Sanraku.jpg' link="/arts/painting-styles/japanese-style" />
