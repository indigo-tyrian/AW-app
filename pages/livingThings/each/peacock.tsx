  ...
  return (
    <>
      <div className={bigImgContainerStyle}>
        <NextImageComp containerClassName={nextImageAdjustment.landscape} boxClassName={bigImgStyle} src="https://images.pexels.com/photos/2196587/pexels-photo-2196587.jpeg" alt="" />
      </div>
